                ...
                <button
                  ...
                  className={`py-2 rounded-xl text-sm font-semibold transition-colors ${
                    isMonthDisabled(m)
                      ...
                      : m === value.month
                        ? "bg-[#FFE493] text-primary-foreground"
                  ...
                  className={`aspect-square text-xs rounded-lg transition-colors flex items-center justify-center ${
                    isDayDisabled(d)
                      ...
                      : d === value.day && selMonth === value.month
                        ? "bg-[#FFE493] text-primary-foreground font-bold"
                        : "hover:bg-primary/20 text-foreground"
                  }`}
                >
                  {d}
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-1.5 -mt-3">
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-3xl border border-border bg-card focus:outline-none focus:ring-2 focus:ring-[#FFF5D4] text-sm placeholder:text-muted-foreground font-semibold"
        />
      </div>
          ...
          {(["born", "expected"] as const).map((t) => (
            <button
              ...
              className={`flex-1 py-2 rounded-3xl text-sm font-semibold border transition-all ${
                form.birthType === t
                  ? "bg-[radial-gradient(ellipse_at_center,#FFFAF0_0%,#FEF5CC_100%)] text-primary-foreground border-primary"
        ...
        <div className="flex gap-2 items-center">
          <div className="relative flex-[1.5]">
            <button
              ...
              className="w-full px-4 py-2 rounded-3xl border border-border bg-card text-sm focus:outline-none focus:ring-2 focus:ring-[#FFF5D4] text-left"
            >
              {form.birthYear}
            </button>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 rounded-3xl border border-border bg-card text-sm focus:outline-none focus:ring-2 focus:ring-[#FFF5D4] placeholder:text-muted-foreground"
              />
              ...
              <div className="mt-1">
                ...
                >
                  {(form.allergens ?? []).map((allergen) => (
                    <span
                      key={allergen.id}
                      className="flex items-center gap-1 pl-3 pr-3 py-1 rounded-full bg-[radial-gradient(ellipse_at_center,#FFFAF0_0%,#FFEEE8_100%)] border border-[#FF8763]/50 text-xs font-semibold text-primary-foreground"
                    >
                  ...
                  <button
                    ...
                    className={`flex flex-row items-center gap-1 px-1.5 py-1 rounded-xl border text-xs font-semibold transition-all ${
                      selected
                        ...
                        : "border-border bg-card text-muted-foreground hover:border-primary/60 hover:bg-[#FFFBE8]"
                    }`}
                  >
                  ...
                  {safeDropdownResults.map((ing) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {!inAllergen && selected && <Check size={13} className="text-[#3E8260] shrink-0" />}
                      </div>
                    );
                  })}
                </div>
              ...
              <div>
                ...
                >
                  {[...(form.safeIngredients ?? [])].sort((a, b) =>
                    ...
                    <span
                      key={s.id}
                      className="flex items-center gap-1 pl-3 pr-2 py-1 rounded-full bg-[radial-gradient(ellipse_at_center,#FFFAF0_0%,#E3FFF1_100%)] border border-[#9AC6AF]/70 text-xs font-semibold text-foreground"
                    >
      ...
      <div className="pt-1 space-y-2">
        <button
          ...
          className="w-full py-3.5 text-[#3D3C38] text-base font-bold rounded-3xl
